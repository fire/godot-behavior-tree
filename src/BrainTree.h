...
public:
	...
	virtual Vector<int> getStatus() const {
		Vector<int> z;
		z.push_back(static_cast<int>(status));
		return z;
	}
...
public:
	...
	Vector<int> getStatus() const {
		Vector<int> z;
		z.push_back(static_cast<int>(status));
		z.append_array(child->getStatus());
